...
bool stateWordSelection(const char* text, const char* corruptChars, unsigned int wordCount, unsigned int* const &wordPosition, unsigned int &wordIndex, unsigned int &wordLength);
bool stateCharacterSelection(const char* text, const char* corruptChars, unsigned int* const &charPosition, unsigned int wordIndex, unsigned int wordLength,
    unsigned int &chosenCharIndex, char &chosenChar);
bool stateChoosingOption(char* charVariations, char chosenChar, unsigned short* const & chosenCharVariationNumber, char &chosenCharVariation);
...
bool stateEndOfStage(unsigned int correctlyGuessedChars, unsigned int userMistakes);
